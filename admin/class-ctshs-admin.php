				...
				<div class="ctdb-outer-wrap">
					...
					<div class="ctdb-banners">
						...
						<div class="ctdb-banner hide-dbpro">
							<a href="http://discussionboard.pro/?utm_source=plugin_ad&utm_medium=wp_plugin&utm_content=super-hero-slider&utm_campaign=dbpro"><img src="<?php echo SHS_PLUGIN_URL . 'assets/images/dbpro-ad-view.png'; ?>" alt="" ></a>
						</div>
						<div class="ctdb-banner">
							<a href="https://sellastic.com/?ref=1&utm_source=plugin_ad&utm_medium=wp_plugin&utm_content=super-hero-slider&utm_campaign=sellastic"><img src="<?php echo SHS_PLUGIN_URL . 'assets/images/sellastic-ad1.jpg'; ?>" alt="" ></a>
						</div>	
						<div class="ctdb-banner">
							<a href="https://catapultthemes.com/downloads/category/themes/?utm_source=plugin_ad&utm_medium=wp_plugin&utm_content=super-hero-slider&utm_campaign=campaign"><img src="<?php echo SHS_PLUGIN_URL . 'assets/images/themes-ad1.jpg'; ?>" alt="" ></a>
						</div>			
					</div>
				</div><!-- .ctdb-outer-wrap -->
			</div><!-- .wrap -->
